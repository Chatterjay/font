...
const GITHUB_URL = 'https://github.com/Chatterjay/font-viewer';
...
const handleClickOutside = (event) => {
  ...
  if (isVisible.value && sidebar && !sidebar.contains(event.target) && !toggleBtn.contains(event.target)) {
      ...
      <div class="settings-section">
        ...
        <div class="settings-item">
          ...
          <button class="action-btn" @click="toggleSidebarPosition">
            <svg viewBox="0 0 24 24" width="20" height="20">
              <path fill="currentColor" d="M4 18h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2zm0-12h16v8H4V6z"/>
            </svg>
      ...
      <div class="settings-section">
        ...
        <div class="settings-item">
          <button class="action-btn" @click="clearCache">
            <svg viewBox="0 0 24 24" width="20" height="20">
              <path fill="currentColor" d="M15 16h4v2h-4zm0-8h7v2h-7zm0 4h6v2h-6zM3 18c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2V8H3v10zm2-8h6v8H5v-8zm5-6H6L5 5H2v2h12V5h-3z"/>
            </svg>
            <span>清除缓存</span>
          </button>
        </div>
      ...
      <div class="settings-section">
        ...
        <div class="settings-item">
          <button class="action-btn" @click="refreshPage">
            <svg viewBox="0 0 24 24" width="20" height="20">
              <path fill="currentColor" d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 12h7V5l-2.35 1.35z"/>
            </svg>
            <span>刷新页面</span>
          </button>
        </div>
